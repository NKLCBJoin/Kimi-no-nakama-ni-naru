...
class board_my_write extends StatefulWidget {
  const board_my_write({Key? key}) : super(key: key);

  @override
  State<board_my_write> createState() => _board_my_writeState();
}

class _board_my_writeState extends State<board_my_write> {
  @override
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      Flexible(
                        flex: 1,
                        child: Text('내가 작성한 글', style: TextStyle(fontSize: 20, color: Colors.black),)
                      ),
                    ],
                  ),
